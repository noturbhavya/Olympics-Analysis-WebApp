...
import pandas as pd
import Scripts.preprocess as preprocess, Scripts.helper as helper
...
st.sidebar.image('c846e7934ab349545af715f07c45e2ff.jpg')
...
if user_menu == 'Overall Analysis':
    ...
    # ✅ Unique key added
    selected_sport = st.selectbox('Select a Sport', sport_list, key="overall_sport")
...
if user_menu == 'Country-wise Analysis':
    ...
    # ✅ Unique key added
    selected_country = st.sidebar.selectbox('Select a Country', country_list, key="country_analysis")
...
if user_menu == 'Athlete wise Analysis':
    ...
    # ✅ Unique key added
    selected_sport = st.selectbox('Select a Sport', sport_list, key="athlete_height_weight")
